...
export const sessionKeys = {
  ...
  join: 'sql-join',
  referralId: 'sql-referral-id', // user's referral id that they can share with others
  ...
  referralCode: 'sql-referral', // referral code that the user used to sign up
  angel: 'sql-angel',
  countryCode: 'sql-country-code',
  complimentaryMembership: 'sql-complimentary-membership',
  membershipType: 'sql-membership-type',
  chargeOnSession: 'sql-charge-on-session', // whether or not to charge the user on session for the payment page
  successfulPayment: 'sql-successful-payment' // whether or not the user has successfully paid for the membership
} as const;
...
export const LOCAL_IP = import.meta.env.MY_DEV_IP || 'localhost';
